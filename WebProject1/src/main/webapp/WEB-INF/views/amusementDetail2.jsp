...
// 		}
	...
	function moveClick(n){
		...
		if(n === 1){
			...
			//rides
			window.scrollTo({ left: 0, top: 1112, behavior: "smooth" });
		}
		else if(n === 3){
			//facility
			window.scrollTo({ left: 0, top: 1853, behavior: "smooth" });
		}
		else if(n === 4){
			//review
			window.scrollTo({ left: 0, top: 2478, behavior: "smooth" });
		}
	}
...
<div class="container mt-5">
	<div class="d-flex">
		...
		<!-- Side widgets-->
		<aside class="col-sm-3 side-widget">
			<div class="container">
