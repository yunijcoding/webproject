...
function init(){
	...
	var confmKey = "U01TX0FVVEgyMDIzMDMxNDA5MDgwNDExMzU4ODc=";
	...
	if(inputYn != "Y"){
		...
		/* 부모창에 값 입력하기 */
		$('input[name=m_address]',opener.document).val($('#roadFullAddr').val());
		$('#m_address',opener.document).val($('#roadFullAddr').val());
		window.close();
		}
}
</script>
<body onload="init();">
	<form id="form" name="form" method="post" action="/jusoEnd">
