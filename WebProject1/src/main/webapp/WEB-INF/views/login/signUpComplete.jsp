...
<html lang="en">
  ...
  <body>
    ...
    <section class="jumbotron text-xs-center" style="margin-top:100px;">
      <div class="container">
        <h1 class="jumbotron-heading mb-3">EXCITING AMUSEMENT <span style="font-weight:bolder;">회원가입이 완료</span>되었습니다.</h1>
        <p class="lead text-muted">
          회원님은 EXCITING AMUSEMENT의 모든 기능을 사용하실 수 있습니다. 회원접속 후 이용가능합니다.
        </p>
        <div>
          <a href="/login" class="btn btn-info">로그인페이지로 이동</a>
