		...
		<form id="search-form" action="/list">
			<div class="row">
				...
				<div class="col">
					<div class="form-floating mb-3">
						<input type="search" name="searchName" class="form-control"
							id="floatingInput" placeholder="놀이기구을 찾아볼까요?"> <label
							for="floatingInput">놀이기구을 찾아볼까요?</label>
					</div>
				</div>
			</div>
			<div class="row">
				...
				<c:forEach items="${listData}" var="data">
					<div class="col mb-5">
						<div class="card h-100">
							<a href="ridesDetail?rides_id=${data['rides_id']}&amuse_id=${data['amuse_id']}"> <img class="custom-card-img" src="${data['r_img']}"
								alt="..." />
							</a>
							<div data-id="${data['rides_id']}"
							...
							<div class="card-body p-4">
								<div class="text-center">${data['r_name']}</div>
							</div>
						</div>
					</div>
				</c:forEach>
